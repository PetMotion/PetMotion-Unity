        ...
        public void DetectSymmetry() {
            ...
            for (int i = 0; i < Source.Bones.Length; i++) {
                ...
                if (source.Contains("Left")) {
                    if (TryAssign(source.Replace("Left", "Right"), i)) {
                        continue;
                    }
                }

                if (source.Contains("Right")) {
                    if (TryAssign(source.Replace("Right", "Left"), i)) {
                        continue;
                    }
                }
                ...
                if (source.Contains("_L_")) {
                    if (TryAssign(source.Replace("_L_", "_R_"), i)) {
                        continue;
                    }
                }

                if (source.Contains("_R_")) {
                    if (TryAssign(source.Replace("_R_", "_L_"), i)) {
                        continue;
                    }
                }

                if (source.Contains("L_")) {
                    if (TryAssign(source.Replace("L_", "R_"), i)) {
                        continue;
                    }
                }

                if (source.Contains("R_")) {
                    if (TryAssign(source.Replace("R_", "L_"), i)) {
                        continue;
                    }
                }

                if (source.Contains("_L")) {
                    if (TryAssign(source.Replace("_L", "_R"), i)) {
                        continue;
                    }
                }

                if (source.Contains("_R")) {
                    if (TryAssign(source.Replace("_R", "_L"), i)) {
                        continue;
                    }
                }
